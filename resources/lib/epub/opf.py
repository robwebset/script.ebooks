...
try:
    ...
    try:
        ...
        try:
            # This installation is Python 2.6 and it does not have the OrderedDict package installed
            # So create one
            ...
            raise ImportError('You should use Python 2.7 or install `ordereddict` from pypi.')
